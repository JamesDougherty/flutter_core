enum CsValveEvb034TypeFull {
  ...
  const CsValveEvb034TypeFull(this.value);
  final int value;

  static CsValveEvb034TypeFull fromInt(int value) {
    return CsValveEvb034TypeFull.values.firstWhere((e) => e.value == value, orElse: () => unknown);
  }
}
